...
public:
    ...
    void push(const juce::AudioBuffer<SampleType>& data)
    {
        ...
        jassert(numberOfItems < bufferNumSamples );
    ...
    void pull(juce::AudioBuffer<SampleType>& data, int numberOfItems)
    {
        ...
        //fifo.prepareToRead(numberOfItems, start1, size1, start2, size2);
    ...
    void pull(SampleType* destination, int channel, int numberOfItems)
    {
        jassert(numberOfItems < buffer.getNumSamples());
